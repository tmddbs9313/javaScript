...
/*전역은 코드의 가장 바깥영역을 말하며 전역은 전역 스코프를 만든다.
    전역에 변수를 선언하면, 전역스코프를 갖는 전역 변수가 되며
    ...
    /*스코프 체인
        ...
        변수를 참조할때 자바 스크립트 엔진은 스콮 체인을 통해 변수를 참조하는 코드의 스코프에서 시작하여
        상위 스코프 방향으로 이동하 선언된 변수를 검색한다
